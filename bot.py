...
client = commands.Bot(command_prefix = 'r.', self_bot=True)
...
async def botinfo(ctx):
    ...
    embed.set_footer(text=f"{ctx.author.display_name}", icon_url=client.user.avatar_url)
...
@client.command()
async def zyper(ctx):
    images=["https://i.imgflip.com/4g7p3e.jpg", "https://i.imgflip.com/4g7p5r.jpg", "https://cdn.discordapp.com/attachments/758907498962092042/758928806999228416/image0.png", "https://cdn.discordapp.com/attachments/758907498962092042/758928807734018058/image1.png", "https://cdn.discordapp.com/attachments/758907498962092042/758928808106917888/image2.png", "https://cdn.discordapp.com/attachments/735197607365705749/758929451592843294/image0.png", "https://cdn.discordapp.com/attachments/758907498962092042/759117480421228574/image0.jpg", "https://cdn.discordapp.com/attachments/758907498962092042/759120101085282354/image0.png"]
    await ctx.message.delete()
    random.seed(a=None)
    embed = discord.Embed(title='Zyper, The Shitty Moderator', color=10181046)
    embed.set_image(url=random.choice(images))
    embed.set_footer(text="Don't Ban Me for Selfbotting")
...
async def pscan(ctx, ip):
        ...
        embed = discord.Embed(title="Port Scan Results", description="%s"%(response.text), color=10181046)
        embed.set_footer(text=f"{ctx.author.display_name}", icon_url=client.user.avatar_url)
        await ctx.send(embed=embed)
        await ctx.message.delete()

@client.command(pass_context=True)
async def pingr(ctx, ip):
        pingrurl = ("https://api.hackertarget.com/nping/?q="+ip)
        response = requests.get(pingrurl)
        embed = discord.Embed(title="Ping Results", description="%s"%(response.text), color=10181046)
        embed.set_footer(text=f"{ctx.author.display_name}", icon_url=client.user.avatar_url)
        await ctx.send(embed=embed)
        await ctx.message.delete()
...
async def logout(ctx): # b'\xfc'
    await ctx.message.delete()
    embed = discord.Embed(description=f"Logging Out... {round (client.latency * 1000)}ms")
    await client.logout()
    await ctx.send(embed=embed)

@client.command()
async def skeek(ctx, member: discord.Member = None):
    images=["https://cdn.discordapp.com/attachments/755904383685886105/758889594728742932/unknown.png", "https://cdn.discordapp.com/attachments/733688460317294592/758878651931820032/unknown.png"]
    random.seed(a=None)
    embed = discord.Embed(title=f"Alexa Said {member.name} Is A Skeek", color=10181046)
    embed.set_image(url=random.choice(images))
    embed.set_footer(text="Don't Ban Me for Selfbotting")
    await ctx.message.delete()
    await ctx.send(embed=embed, delete_after=5)
...
@client.command()
async def litbeefrn(ctx, member: discord.Member = None):
    embed = discord.Embed(title="Lit Beef RN", color=10181046)
    embed.set_image(url='https://cdn.discordapp.com/emojis/633385345890648104.png?v=1')
    embed.set_footer(text="Don't Ban Me for Selfbotting")
    await ctx.message.delete()
    await ctx.send(embed=embed, delete_after=5)
...
async def boot(ctx):
    ...
    await ctx.send("**1**")
    time.sleep(1)
    await ctx.send("`Nigga you Offline.`", delete_after=3)
...
async def whois(ctx, *, user: discord.Member = None): # b'\xfc'
    ...
    embed = discord.Embed(description=user.mention, text='ID: ' + str(user.id), color=10181046)
...
async def about(ctx, member: discord.Member = None):
    await ctx.message.delete()
    embed = discord.Embed(title="About Replays Selfbot :heart:", color=10181046, inline=True)
    embed.add_field(name="Developer:", value="Replays", inline=True)
    embed.add_field(name="Website:", value="https://replays.us", inline=True)
    embed.add_field(name="Language:", value="Python", inline=True)
    embed.add_field(name="Version:", value="1.1", inline=True)
    embed.set_image(url='https://i.imgur.com/BotBvgp.gif')
    embed.set_footer(text=f"{ctx.author.display_name}", icon_url=client.user.avatar_url)
    await ctx.send(embed=embed)
...
async def help(ctx, member: discord.Member = None):
    ...
    embed.add_field(name='>owner', value='Shows Owner Commands', inline=True)
...
async def owner(ctx):
    ...
    embed.add_field(name='>logout', value='Logs Out of Selfbot', inline=True)
    embed.set_footer(text=f"Commands requested by {ctx.author.display_name}", icon_url=client.user.avatar_url,)
    await ctx.message.delete()
    await ctx.send(embed=embed)
...
async def tools(ctx):
    ...
    embed.add_field(name='>whois', value='Shows You Information on a Discord User', inline=True)
